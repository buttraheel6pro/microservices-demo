...
export class MessagingService implements OnModuleInit {
  ...
  private async setupSubscriptions(): Promise<void> {
    // notification-service listens to all 3 topics via notification-queue
    await this.ensureSubscription('notification-queue', 'order-topic');
    await this.ensureSubscription('notification-queue', 'inventory-topic');
    await this.ensureSubscription('notification-queue', 'payment-topic');
  }
